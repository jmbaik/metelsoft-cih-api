...
public class PrayerService {
    ...
    public List<String> selectYmFromDogoPrayer(){
        return mapper.selectYmFromDogoPrayer();
    }
    ...
    public void deleteDogoPrayerByCat(DogoPrayer dto) {
        mapper.deleteDogoPrayerByCat(dto);
    }
